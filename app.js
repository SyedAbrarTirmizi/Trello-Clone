...
for (let i = 0; i < column.length; i++) {
  ...
  form.addEventListener("submit", addTask); // Add Event Listenner on Submit
}

const createTicket = (value) => {
  const ticket = document.createElement("p"); // Creat a Function to Create new Ticket on Add Task
